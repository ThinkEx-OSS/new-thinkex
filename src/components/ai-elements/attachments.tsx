	...
	return (
		<Button
			...
			className={cn(
				...
				variant === "inline" && [
					"size-5 rounded p-0",
					"text-muted-foreground opacity-0 transition-opacity group-hover:opacity-100 hover:bg-muted hover:text-destructive",
					"[&>svg]:size-2.5",
				],
				variant === "list" && [
					"size-8 shrink-0 rounded p-0 text-muted-foreground hover:bg-muted hover:text-destructive",
					"[&>svg]:size-4",
				],
				className,
			)}
