...
function AlertDialogFooter({
	...
	return (
		<div
			...
			className={cn(
				"-mx-6 -mb-6 flex flex-col-reverse gap-2 rounded-b-xl border-t bg-dialog-footer p-4 group-data-[size=sm]/alert-dialog-content:grid group-data-[size=sm]/alert-dialog-content:grid-cols-2 sm:flex-row sm:justify-end",
				className,
			)}
			{...props}
		/>
