/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 48c9f9f9ffe5590354b67fda97dc4bd0)
// Runtime types generated with workerd@1.20260508.1 2026-01-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "WorkspaceRoom" | "WorkspaceChatDirectory";
	}
	interface Env {
		...
		WorkspaceRoom: DurableObjectNamespace<import("./src/server").WorkspaceRoom>;
		WorkspaceChatDirectory: DurableObjectNamespace<import("./src/server").WorkspaceChatDirectory>;
	}
}
